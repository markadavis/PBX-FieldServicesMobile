...
sap.ui.define([
	...
	// Because of workaround (https://bugs.webkit.org/show_bug.cgi?id=198375) applied in _createChart function the overlay height needs to be set manually
	...
	SmartChart.prototype._createChart = function() {
		...
		//Workaround for Safari and Chrome browsers as described via https://bugs.webkit.org/show_bug.cgi?id=198375
