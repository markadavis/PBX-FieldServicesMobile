...
sap.ui.define([
	...
	'sap/m/List',
	'sap/m/Link',
	'sap/ui/comp/valuehelpdialog/P13nFilterPanel',
		...
		if (aTokens.length) {
			...
			for (var i = 0; i < aTokens.length; i++) {
				...
				if (token.data("range")) {
					...
					this._addToken2Tokenizer(sKey, theTokenText, this._oSelectedTokens, range.keyField);
		...
		this._oFilterPanel = new P13nFilterPanel(this.getId() + "-filterPanel", {
			...
			filterItemChanged: function(oEvent) {
				...
				if (oItem && sReason === "added") {
					...
					this._addToken2Tokenizer(sKey, sTokenText, this._oSelectedTokens, oRange.keyField);
					this._updateTokenizer();
				}
