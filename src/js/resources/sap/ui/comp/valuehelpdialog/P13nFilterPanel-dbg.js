...
sap.ui.define([
	...
	'sap/ui/comp/valuehelpdialog/P13nConditionPanel',
	'sap/m/Panel',
	'sap/m/library',
	 ...
	 * @alias {sap.ui.comp.valuehelpdialog.P13nFilterPanel}
	 */
	var P13nFilterPanel = P13nFilterPanelBase.extend("sap.ui.comp.valuehelpdialog.P13nFilterPanel", /** @lends sap.m.P13nFilterPanel.prototype */ {
		metadata: {
	...
	P13nFilterPanel.prototype._enhanceFieldOperationsWithEmpty = function (oField, bNullable) {
		...
		if (
			...
			aIncludeOperations = this._oConditionPanel.getOperations(oField.type, false);
			aExcludeOperations = this._oConditionPanel.getOperations(oField.type, true);
