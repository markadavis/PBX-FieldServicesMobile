...
sap.ui.define(['jquery.sap.global', 'sap/base/Log', 'sap/ui/Device'], function(jQuery, Log, Device) {
	...
	function doExport(mParams, fnCallback) {
		...
		if (oCustomCurrencyConfig) {
			...
			mParams.customizing = mParams.customizing || {};
			mParams.customizing.currency = {};

			for (sCurrencyCode in oCustomCurrencyConfig) {
				mParams.customizing.currency[sCurrencyCode] = { scale: oCustomCurrencyConfig[sCurrencyCode].digits };
			}
		}
