...
sap.ui.define([
	...
	var ContentConnector = Element.extend("sap.ui.vk.ContentConnector", /** @lends sap.ui.vk.ContentConnector.prototype */ {
		...
		constructor: function(sId, mSettings) {
			...
			// Set to true if there was a request to update content resources when the previous update has not finished yet.
	...
	/**
	 * Sets the number of retry attempts for a download operation if the initial request to retrieve a model from a
	 * remote server could not be fulfilled and the error with which the request failed is considered retriable.
	 *
	 ...
	 * with an error that is considered retriable then the <i>download manager</i> will keep on trying issuing new
	 ...
	 *
	 * <b>Retriable errors</b>: The following errors are considered retriable:
	 * <ul>
	 ...
	 *
	 *
	 * @param {int} retryCount Number of retry attempts. Value must be non-negative.
