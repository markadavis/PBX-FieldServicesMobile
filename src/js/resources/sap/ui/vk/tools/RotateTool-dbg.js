...
sap.ui.define([
	 ...
	 * @param {sap.ui.vk.tools.CoordinateSystem} [coordinateSystem] Optional parameter to define coordinate system to be used when these coordinates are applied. If not specified then currently set coordinate ssystem will be used.
	 * @returns {sap.ui.vk.tools.RotateTool} <code>this</code> to allow method chaining.
	 * @public
	 */
	...
	/**
	 * Change the rest postions of selected node by rotation, if the node is within a rotational animation track,
