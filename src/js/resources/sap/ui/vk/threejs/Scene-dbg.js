...
sap.ui.define([
	...
	Scene.prototype._computeBoundingBox = function(visibilityLayers, ignoreDynamicObjects, ignore2DObjects) {
		var boundingBox = new THREE.Box3();
		if (this._scene) {
			this._scene._expandBoundingBox(boundingBox, visibilityLayers, ignoreDynamicObjects, ignore2DObjects);
		}
		return boundingBox;
	};
