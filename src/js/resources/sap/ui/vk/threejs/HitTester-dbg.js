...
sap.ui.define([
	...
	HitTester.prototype.hitTest = function(x, y, width, height, renderer, scene, camera, clippingPlanes) {
	...
	HitTester.prototype.hitTestPrecise = function(x, y, width, height, scene, camera, clippingPlanes) {
		...
		if (intersects) {
			for (var i in intersects) {
				...
				if (object.layers.test(camera.layers) && !object.isBillboard && !object.isDetailView) {
