...
sap.ui.define(["sap/ui/thirdparty/jquery", "./BaseController", "./DraftContext", "sap/base/Log", "sap/ui/model/Context", "sap/ui/generic/app/util/ActionUtil"
	...
	var DraftController = BaseController.extend("sap.ui.generic.app.transaction.DraftController", {
		metadata: {
			publicMethods: [
				"getDraftContext", "getDraftForActiveEntity", "createNewDraftEntity", "createEditDraftEntity", "validateDraftEntity", "validateDraft", "prepareDraft", "prepareDraftEntity", "saveAndPrepareDraftEntity", "activateDraftEntity", "isActiveEntity", "hasActiveEntity", "destroy", "fetchHeader", "discardDraft"
			]
		},
	 ...
	 * This method can be used when the consumer also want to retrieve the header data with selected associations expanded.
	 *
	 * @param {sap.ui.model.Context} oContext The given binding context
	 * @param {map} mParameters Parameters to control the behavior of the request
	 * @returns {Promise} A <code>Promise</code> for asynchronous execution
	...
	DraftController.prototype.fetchHeader = function(oContext, mParameters) {

		mParameters = mParameters || {};
		mParameters.batchGroupId = "Changes";
		mParameters.successMsg = "Header section is fetched successfully";
		mParameters.failedMsg = "Fetching header data failed";
		mParameters.context = oContext;
		mParameters.forceSubmit = true;

		return this._read(oContext.getPath(), mParameters);
	};
