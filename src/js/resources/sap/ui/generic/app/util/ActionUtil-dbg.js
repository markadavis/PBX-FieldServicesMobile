								...
								if (mParameterForm.getEmptyMandatoryFields().length == 0) {
									...
									that._oActionPromiseCallback.resolve({
										...
										.then(function (aResults) {
											// If any of the funntion import is successful, we consider this as success to synchronise it other BOPF action
									...
									var _dataObject = oActionContext.getObject();
