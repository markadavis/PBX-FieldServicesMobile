sap.ui.define([
	...
	return Controller.extend("com.publix.eula.controller.VendorLogon", {
		...
		onInit: function() {
			...
			this.oView.setModel(oViewModel, "VendorLogonView");

			this._oRouter.getRoute("vendorLogon").attachPatternMatched(this._onRouteMatched, this);
			this._oRouter.getRoute("vendorRedirect").attachPatternMatched(this._onRouteMatched, this);
		},
		...
		onLogonPress: function(oEvent) {
			this._oComponent.vendorLogon().then(oEulaStatus => {
