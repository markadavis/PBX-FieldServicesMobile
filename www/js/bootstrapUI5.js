/**
 * @fileOverview The SAPUI5 "Unified Shell" bootstrap code.
 *
 * @version 1.84.34
 */
...
(function () {
     ...
     * The original function mya have been moved to sap.ui2.srvc.utils(?).
     */
    ...
    /**
     * The 'ushell bootstrap' is registered as the SAPUI5 boot task; For consistency with the ABAP stack, this
     * is required because some UI5 settings (e.g. theme) are retrieved from the back-end and have to be set early
     * in the UI5 bootstrap.
     */
    ...
    /**
     * Attach private functions which should be testable to the public namespace to make them available outside.
     */
